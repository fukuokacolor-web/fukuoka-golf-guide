...
| `hub-traveler.html` | `book-fukuoka-traveler.html` | 「観光ゴルフ5選ガイド →」 |
| `hub-beginner.html` | `book-fukuoka-beginner.html` | 「初心者向けコース4選を見る →」 |
| `hub-business.html` | `book-fukuoka-business.html` | 「接待ゴルフ5選・幹事チェックリスト →」 |
...
作成状況: ✅ **作成済み** (`0ee2f64` / 2026-05-10)
- MARKER: `<!-- phase4-lp-title-v1 -->`
- dry-run 検証済: 6 would_replace
- Day 28 当日は `python scripts/phase4_lp_title_fix.py --dry-run` で差分確認してから実行

---

## 8b. 2026-05-30 追加 LP ページ (内部リンク計画に追加)

観測フェーズ中 (2026-05-30) に新規 LP を 3本追加作成。Day 28 GO 後に内部リンク追加が必要:

| LP ファイル | ターゲット KW | 推奨リンク元 |
|---|---|---|
| `book-fukuoka-beginner.html` | 福岡 ゴルフ 初心者 | hub-beginner.html / index.html |
| `book-fukuoka-traveler.html` | 福岡 観光 ゴルフ / 糸島 ゴルフ | hub-traveler.html / area-itoshima.html |
| `book-fukuoka-business.html` | 福岡 接待 ゴルフ / 名門 ゴルフ | hub-business.html |
