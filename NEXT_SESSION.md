...
### ⏭️ 次の選択肢 (CVR佐藤の「第2段」・未着手)
- 若松142表示/福岡CC高表示の死に筋を更に刈るなら、上部に「予約できる近隣コース」CTAカード3枚(探す/空き確認の動詞・煽らない)を追加する案。related-cards差替より大きい改修なので別途判断。
- ほか高表示・低CTRページの title/meta 改善 (hub-business 253表示/CTR2% 等)
