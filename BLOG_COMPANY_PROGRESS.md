...
| **3** | テンプレート化 (複数サイト雛形) | 12-20h | ⏳ **3.1+3.2 完了 (2026-05-11)・残 3.3-3.4** |
...
### 🆕 Phase 3.2 で発見されたテンプレ改善点

CLAUDE.md 逆適用で気付いた「テンプレに足りなかった項目」:

1. **§10 ファイル役割分担表** — テンプレに含めるべき (どのファイルがどの頻度で更新されるか・運用が安定する)
2. **§13 構造サマリ (エリア × ペルソナハブ × 多言語 Tier)** — ブログサイトごとに「カテゴリ分類」のサマリを CLAUDE.md に持つ価値あり
3. **§14 Phase 履歴サマリ** — NEXT_SESSION.md の最新だけでなく、Phase milestone のタイムラインを CLAUDE.md に静的保存

→ Phase 3.4 でテンプレに反映予定 (現状は本 commit でテンプレ実証 = 必要十分とする)
